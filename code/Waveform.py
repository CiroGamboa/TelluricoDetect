...
#                print(station_wave)
    ...
    def get_event_spec_stats(self):
        traces = []
        for trace in self.st:
            if(TelluricoTools.check_trace(trace) and trace.stats.channel[1] != 'N' and trace.stats.station in self.stations):
                traces.append(trace)
